...
//    private OnClickProductImage onClickProductImage;
    ...
    public static ProductImageFragment newInstance(List<Integer> imgResList, Integer imagePosition) {
        ProductImageFragment fm = new ProductImageFragment();
        Bundle args = new Bundle();
        args.putInt("imgPos", imagePosition);
        args.putIntegerArrayList("imgResList", new ArrayList<>(imgResList));
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgResList = args.getIntegerArrayList("imgResList");
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (imgPos <= 4) {
            LoadImageUtils.loadImageFromUrl(url[imgPos], imageView, new OnLoadImageListener() {
                @Override
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<Integer> mList = new ArrayList<>(imgResList);
